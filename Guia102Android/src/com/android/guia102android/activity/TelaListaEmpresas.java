...
public class TelaListaEmpresas extends Guia102Activity implements
	...
	public void executar() throws Exception {
		...
		this.empresas = Guia102Service.getEmpresas(TelaListaEmpresas.this,
				"XmlEmpresas", atividadeId, cidadeId);
	}

	@Override
	protected void onSaveInstanceState(Bundle outState) {
		super.onSaveInstanceState(outState);
		outState.putSerializable(ListaAtividades.KEY, new ListaEmpresas(
				empresas));
	}
