...
public class TelaListaAtividades extends Guia102Activity implements
	...
	if (savedInstanceState != null) {
	    ListaAtividades lista = (ListaAtividades) savedInstanceState.getSerializable(ListaAtividades.KEY);
	...
	outState.putSerializable(ListaAtividades.KEY, new ListaAtividades(atividades));
    }
